    ...
    async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
        ...
        if settings.auto_migrate_on_boot:
            try:
                ...
                # surface the issue ("schema_missing" / "unreachable") and
                # the operator can intervene. The blanket catch is
                # intentional: any failure here (network, perms, schema
                # conflict) must NOT prevent the app from booting and
                # serving /v1/health, /v1/ready.
